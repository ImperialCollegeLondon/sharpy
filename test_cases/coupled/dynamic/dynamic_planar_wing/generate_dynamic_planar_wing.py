...
def generate_aero_file(route, case_name, num_elem, num_node, coordinates):
    ...
    surface_distribution[int(num_elem/2):] = 1
...
def generate_solver_file(route, case_name):
    ...
    config['SHARPy'] = {'case': 'dynamic_planar_wing',
                        'route': './test_cases/coupled/dynamic/dynamic_planar_wing/',
...
if __name__ == '__main__':
    ...
    generate_files(dir_path + '/', 'dynamic_planar_wing', 40, 3)
