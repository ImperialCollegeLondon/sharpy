...
def run(specimen_list, label):
    ...
    components_sett['workflow'] = ['create_structure', 'create_aero']
    ...
    simulation_sett = {'sharpy': {'simulation_input': None,
                           ...
                           'default_solution_vars': {
                               ...
                               's_load_steps': 1,     
                               's_delta_curved': 1e-4,
                               'add2_flow':[['StaticCoupled',['WriteVariablesTime', 'plot']]],
                               'WriteVariablesTime':{'structure_variables':
                                                     ['pos', 'psi'],
