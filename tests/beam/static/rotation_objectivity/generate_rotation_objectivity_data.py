...
def generate_solver_file(route, case_name):
    ...
    config['SHARPy'] = {'case': 'rotation_objectivity',
                        'route': './tests/beam/static/rotation_objectivity',
...
if __name__ == '__main__':
    ...
    generate_files(dir_path + '/', 'rotation_objectivity', 10, 3)
