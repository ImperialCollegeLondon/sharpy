...
# Problem Set up
def generate_pazy(
    u_inf, case_name, output_folder="/output/", cases_folder="", **kwargs
):
    # u_inf = 60
    ...
    settings["DynamicCoupled"] = {
        ...
        "network_settings": {
            "variables_filename": "./variables_coarse.yaml",
...
if __name__ == "__main__":
    ...
    generate_pazy(
        u_inf,
        case_name,
        output_folder="./output/test_65001_wake3_M{:g}N{:g}Ms{:g}_alpha{:04g}/".format(
            M, N, Ms, alpha * 100
        ),
