...
def generate_fem_file():
    ...
    # x[working_node:working_node + num_node_main - 1] = np.sin(sweep)*0.5*(1.0 - np.cos(domain[:-1]*np.pi))*main_span
    # y[working_node:working_node + num_node_main - 1] = -np.cos(sweep)*0.5*(1.0 - np.cos(domain[:-1]*np.pi))*main_span
