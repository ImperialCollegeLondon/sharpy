...
case_rmks = 'M%gN%gMsf%g_tb%g' % (M, N, Msf, track_body)
...
settings['LinDynamicSim'] = {'dt': ws.dt,
                             ...
                             'input_generators': [
                                 {'name': 'control_surface_deflection',
                                  'index': 0,
                                  'file_path': ws.case_route + '/' + ws.case_name + '_elevator.txt'},
                                 {'name': 'dot_control_surface_deflection',
                                  'index': 0,
                                  'file_path': ws.case_route + '/' + ws.case_name + '_elevator_dot.txt'},
                                 {'name': 'control_surface_deflection',
                                  'index': 1,
                                  'file_path': ws.case_route + '/' + ws.case_name + '_elevator1.txt'},
                                 {'name': 'dot_control_surface_deflection',
                                  'index': 1,
                                  'file_path': ws.case_route + '/' + ws.case_name + '_elevator_dot1.txt'},
                             ],
                             'write_dat': ['x', 'y', 't', 'u'],
...
np.savetxt(ws.case_route + '/' + ws.case_name + '_elevator.txt', delta)
np.savetxt(ws.case_route + '/' + ws.case_name + '_elevator_dot.txt', delta_dot)
np.savetxt(ws.case_route + '/' + ws.case_name + '_elevator1.txt', -delta)
np.savetxt(ws.case_route + '/' + ws.case_name + '_elevator_dot1.txt', -delta_dot)
