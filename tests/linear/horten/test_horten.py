...
def run_rom_convergence(
    case_name, case_route="./cases/", output_folder="./output/", **kwargs
):
    M = kwargs.get("M", 4)
    N = kwargs.get("N", 11)
    ...
    ws.update_mass_stiffness(sigma=0.5, sigma_mass=1.0, payload=payload)
    ws.update_fem_prop()
    ...
    settings["StaticCoupled"] = {
        ...
        "aero_solver_settings": {
            ...
            "velocity_field_input": {"u_inf": ws.u_inf, "u_inf_direction": [1.0, 0, 0]},
            "rho": ws.rho,
        },
        "max_iter": 200,
        "n_load_steps": 1,
    ...
    settings["FrequencyResponse"] = {"print_info": "on", "frequency_bounds": [0.1, 100]}
