...
@unittest.skip(
    "Not a robust test case that is giving too many failures. Use test_krylov instead"
)
class TestKrylovRom(unittest.TestCase):
    ...
    def test_siso_ct(self):
        ...
        print(
            "Frequency Response Error at %.2f rad/s: %.2e"
            % (interpolation_point.imag, freq_error)
        )
    ...
    def test_siso_dt(self):
        ...
        print(
            "Frequency Response Error at %.2f rad/s: %.2e"
            % (interpolation_point_ct.imag, freq_error)
        )
    ...
    def test_siso_dt_multipoint(self):
        ...
        for i in range(len(interpolation_point_ct)):
            ...
            print(
                "Frequency Response Error at %.2f rad/s: %.2e"
                % (interpolation_point_ct[i].imag, freq_error)
            )
            self.assertTrue(freq_error < self.tolerance)
