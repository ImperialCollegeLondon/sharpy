...
# FLIGHT CONDITIONS
u_inf = 32.0  # [m/s] Flight velocity
...
# 19 elements
alpha_rad = 2.55901736224966132*np.pi/180
cs_deflection = 1.93512505425033673*np.pi/180
thrust = 1.8563061161804189
...
ea_offset = 0.13 # from Mardanpour
main_ea = loc_cg-ea_offset
...
ea = 1e6*sigma_richards
ga = 1e6*sigma_richards*10
gj = 4.24e5*sigma_richards*10
eiy = 3.84e5
eiz = 2.46e7*sigma_richards
...
mu_temp = mu_0*c_bar_temp**1
#j_temp = mu_temp*5 #j_root*c_bar_temp**2
j_temp = j_root*c_bar_temp**1
...
for stiff_entry in range(1, n_stiffness):
    base_stiffness[stiff_entry, :, :] = stiffness_root*c_bar_temp[stiff_entry-1]**1
