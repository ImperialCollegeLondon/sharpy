...
# TRIM CONDITIONS
alpha_rad = 5.3183323049876092*np.pi/180
beta = 0.0
roll = 0.0
gravity = 'on'
cs_deflection =-3.3213793089859798*np.pi/180
thrust = 3.194225649768598
sigma = 1
