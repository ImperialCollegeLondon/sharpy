...
class HortenWing:
    ...
    def update_mass_stiffness(self, sigma=1.):
        ...
        # Lumped mass inertia
        lumped_mass_inertia[0, :, :] = np.array([0.29547, 0.29322, 0.29547])
        lumped_mass_inertia[1, :, :] = np.array([0.29547, 0.29322, 0.29547])
        lumped_mass_inertia[2, :, :] = np.array([0.5, 1, 1]) * lumped_mass[2]
