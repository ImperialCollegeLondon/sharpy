...
class TestDoublePendulumSlanted(unittest.TestCase):
    ...
    def _setUp(self, lateral):
        ...
        beam1.StructuralInformation.generate_uniform_beam(node_pos1, mass_per_unit_length, mass_iner, mass_iner/2.0, mass_iner/2.0, np.zeros((3,),), EA, GA, GA, GJ, EI, EI, num_node_elem = 3, y_BFoR = 'y_AFoR', num_lumped_mass=1)
        ...
        beam2.StructuralInformation.generate_uniform_beam(node_pos2, mass_per_unit_length, mass_iner, mass_iner/2.0, mass_iner/2.0, np.zeros((3,),), EA, GA, GA, GJ, EI, EI, num_node_elem = 3, y_BFoR = 'y_AFoR', num_lumped_mass=1)
    ...
    def run_and_assert(self, name, lateral):
        ...
        calc_pos_tip_data = ag.multiply_matrices(ag.rotation3d_z(-lateral), for_pos_tip_data[-1, 1:4] + ag.multiply_matrices(ag.quat2rotation(quat_tip_data[-1, 1:]), pos_tip_data[-1, 1:]))
