...
excel_description = {
    "excel_file_name": os.path.abspath(
        sharpydir.SharpyDir
        + "/docs/source/content/example_notebooks/source/type02_db_NREL5MW_v02.xlsx"
    ),
...
rotor = template_wt.rotor_from_excel_type03(
...
SimInfo.solvers["SteadyVelocityField"]["u_inf_direction"] = np.array([0.0, 0.0, 1.0])
...
SimInfo.solvers["StaticCoupled"]["structural_solver_settings"] = SimInfo.solvers[
    "NonLinearStatic"
]
...
SimInfo.solvers["WriteVariablesTime"]["FoR_number"] = [
    0,
]
