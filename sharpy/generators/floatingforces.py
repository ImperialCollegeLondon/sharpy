...
class FloatingForces(generator_interface.BaseGenerator):
    ...
    def generate(self, params):
        ...
        struct_tstep.runtime_generated_forces[self.buoyancy_node, 0:3] += np.dot(cbg, hd_forces_g[0:3])
        struct_tstep.runtime_generated_forces[self.buoyancy_node, 3:6] += np.dot(cbg, hd_forces_g[3:6])
