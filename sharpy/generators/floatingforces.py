...
def compute_xf_zf(hf, vf, l, w, E, A, cb):
    """
        ...
        Originally from:
            ...
            NREL/TP-500-41958
        However, equation 2-37b is thought to be wrong (it is just a copy from eq 2-35b)
        This was corrected according to the theory review of MAP++:
            https://map-plus-plus.readthedocs.io/en/latest/theory.html
    """
