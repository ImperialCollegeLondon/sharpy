...
class TurbVelocityFieldBts(generator_interface.BaseGenerator):
    ...
    settings_description['turbulent_field'] = 'XDMF file path of the velocity file'
    ...
    settings_description['case_with_tower'] = 'Will the SHARPy case include the tower in the simulation?'
