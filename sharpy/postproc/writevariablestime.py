...
class WriteVariablesTime(BaseSolver):
    ...
    settings_default['FoR_variables'] = list()
    ...
    settings_default['structure_variables'] = list()
    ...
    settings_default['aero_panels_variables'] = list()
    ...
    settings_default['aero_nodes_variables'] = list()
