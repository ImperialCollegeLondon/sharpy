...
class Flutter(Linear, Static, Basic):
    ...
    def sol_145(self,
                ...
                velocity_range=[],          
                root_method='secant',       
                flutter_reference=None,     
                velocity_increment=10.,     
                flutter_error=0.1,          
                damping_tolerance=5e-3,     
                frequency_cutoff=0,         
                gravity_linearise=True,     
        ...
        self.settings_new['LinearAssembler']['inout_coordinates'] = linear_coordinates # 'nodes', 'modes'
    ...
    def sol_152(self,
        ...
        predefined_flow = self.predefined_flows['146']
        if primary:
            self.set_flow(predefined_flow, **kwargs)
            self.set_struct_loader(**kwargs)
            self.set_constants(**kwargs)
            self.set_plot(**locals(), **kwargs())
        ...
        settings_new['StaticCoupled']['print_info'] = print_info
        ...
        settings_new['Modal']['print_info'] = print_info
        if  rom_method == '': # Flutter using the full assembled matrices
            rom_settings = {}
        ...
        settings_new['AsymptoticStability'] = {'print_info': print_info,
                                               'velocity_analysis': velocity_range,
                                               }

        settings_new['DynamicLoads'] = {'print_info': print_info,
                                        'reference_velocity': flutter_reference,
                                        'velocity_increment': velocity_increment,
                                        'flutter_error': flutter_error,
                                        'root_method': root_method,
