...
dQshort = dQshort.subs(
    (ra_x * rb_y - ra_y * rb_x) ** 2
    + (-ra_x * rb_z + ra_z * rb_x) ** 2
    + (ra_y * rb_z - ra_z * rb_y) ** 2,
    vcross2,
)
...
dQshort = dQshort.subs(
    (
        rab_x * (-rb_x / rb_norm + ra_x / ra_norm)
...
ra_rcross_x, ra_rcross_y, ra_rcross_z = sm.symbols(
    "ra_rcross_x ra_rcross_y ra_rcross_z"
)
rb_rcross_x, rb_rcross_y, rb_rcross_z = sm.symbols(
    "rb_rcross_x rb_rcross_y rb_rcross_z"
)
