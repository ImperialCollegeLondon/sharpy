...
FlpStff = 1e12*np.ones((n_elem_structural, ))
EdgStff = 1e12*np.ones((n_elem_structural, ))
GJStff = 1e12*np.ones((n_elem_structural, ))
EAStff = 1e12*np.ones((n_elem_structural, ))
