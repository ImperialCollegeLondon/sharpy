...
class DynamicUVLM(BaseSolver):
    ...
    settings_description["include_unsteady_force_contribution"] = (
        "If on, added mass contribution is added to the forces. This depends on the"
        " time derivative of the bound circulation. Check ``filter_gamma_dot`` in the"
        " aero solver"
    )
    ...
    settings_description["postprocessors_settings"] = (
        "Dictionary with the applicable settings for every ``psotprocessor``. Every"
    ...
    def initialise(self, data, custom_settings=None, restart=False):
        ...
        self.aero_solver.initialise(
            self.data, self.settings["aero_solver_settings"], restart=False
        )
