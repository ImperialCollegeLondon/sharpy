...
# rotation
rotation_velocity = 2.0*0.5
dphi = 1*deg2rad
revs_to_simulate = 0.25
...
SimInfo.solvers['SHARPy']['flow'] = ['BeamLoader',
                                'AerogridLoader',
                                'DynamicCoupled']
global name_direct_fixingrotation
name_direct_fixingrotation = 'dpg_direct_fixingrotation'
SimInfo.solvers['SHARPy']['case'] = name_direct_fixingrotation
