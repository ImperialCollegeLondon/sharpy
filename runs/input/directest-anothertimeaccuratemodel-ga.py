...
SimInfo.solvers['SHARPy']['flow'] = ['BeamLoader',
                                'AerogridLoader',
                                'DynamicCoupled']
global name_direct_anothertimeaccuratemodel_ga
name_direct_anothertimeaccuratemodel_ga = 'dpg_direct_anothertimeaccuratemodel_ga'
SimInfo.solvers['SHARPy']['case'] = name_direct_anothertimeaccuratemodel_ga
