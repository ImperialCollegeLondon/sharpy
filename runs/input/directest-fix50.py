...
SimInfo.solvers['SHARPy']['flow'] = ['BeamLoader',
                                ...
                                'DynamicCoupled']
global name_direct
name_direct = 'dpg_direct'
SimInfo.solvers['SHARPy']['case'] = name_direct
...
LC2.body = 0
LC2.body_FoR = 1
LC2.rot_axisB = np.array([0.0,0.0,1.0])
...
LC3.body = 0
LC3.body_FoR = 2
LC3.rot_axisB = np.array([0.0,0.0,1.0])
LC3.scalingFactor = 1e6
LC3.penaltyFactor = 1e-12
