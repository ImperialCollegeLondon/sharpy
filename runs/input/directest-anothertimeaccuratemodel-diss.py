...
SimInfo.solvers['SHARPy']['flow'] = ['BeamLoader',
                                'AerogridLoader',
                                'DynamicCoupled']
global name_direct_anothertimeaccuratemodel_diss
name_direct_anothertimeaccuratemodel_diss = 'dpg_direct_anothertimeaccuratemodel_diss'
SimInfo.solvers['SHARPy']['case'] = name_direct_anothertimeaccuratemodel_diss
