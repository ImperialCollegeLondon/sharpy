...
SimInfo.solvers['SHARPy']['flow'] = ['BeamLoader',
                                'AerogridLoader',
                                'DynamicCoupled']
global name_direct_anothertimeaccuratemodel
name_direct_anothertimeaccuratemodel = 'dpg_direct_anothertimeaccuratemodel'
SimInfo.solvers['SHARPy']['case'] = name_direct_anothertimeaccuratemodel
