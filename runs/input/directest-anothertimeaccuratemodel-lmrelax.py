...
SimInfo.solvers['SHARPy']['flow'] = ['BeamLoader',
                                'AerogridLoader',
                                'DynamicCoupled']
global name_direct_anothertimeaccuratemodel_lmrelax
name_direct_anothertimeaccuratemodel_lmrelax = 'dpg_direct_anothertimeaccuratemodel_lmrelax'
SimInfo.solvers['SHARPy']['case'] = name_direct_anothertimeaccuratemodel_lmrelax
...
SimInfo.solvers['NonLinearDynamicMultibody']['relax_factor_lm'] = 0.4
