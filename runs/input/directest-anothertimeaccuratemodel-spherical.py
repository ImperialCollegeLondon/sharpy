...
SimInfo.solvers['SHARPy']['flow'] = ['BeamLoader',
                                'AerogridLoader',
                                'DynamicCoupled']
global name_direct_anothertimeaccuratemodel_spherical
name_direct_anothertimeaccuratemodel_spherical = 'dpg_direct_anothertimeaccuratemodel_spherical'
SimInfo.solvers['SHARPy']['case'] = name_direct_anothertimeaccuratemodel_spherical
...
LC3 = gc.LagrangeConstraint()
LC3.behaviour = 'spherical_node_FoR'
LC3.node_in_body = nnodes1-1
LC3.body = 1
LC3.body_FoR = 2
LC3.scalingFactor = 1e6
